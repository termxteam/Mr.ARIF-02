#!/bin/sh
#apa liat liat mau recode lu kira buat sc tu mudah dan elu malah enak²kan recode sc gua emng lu sampaj anjeng
#satu pesan buat kang RECODE
#LU SAMPAH AJG KAGAK GUNA LU ASU
#oy ajg lu kok mau recode izin dulu nih wa gua +62 822 6027 6155
#kapan lu pandai kok cuman mau main recode aja ngotak asu

echo $cy
figlet "BEBAN KELUARGA"
echo $w"—————————————————————————————————————————————————————"
echo $cy" Author"$r"  : "$cy"MR ARIF "
echo $cy" GitHub"$r"  : "$cy"https://github.com/termxteam "
echo $cy" Wa "$r"     : "$cy"+62 822 6027 6155 "
echo $cy" Team"$r"    : "$cy"TERMUX CYBER TEAM"
echo $w"—————————————————————————————————————————————————————"
echo
echo
...
then
clear
echo $y"TERIMAKASIH TELAH MENGGUNAKAN TOOLS INI WAHAI PARA BEBAN NEGARA + BEBAN KELUARGA!!"
sleep 2
echo $cy"SEMOGA HARIMU BAHAGIA WAHAI BEBAN KELUARGA+BEBAN NEGARA:)"
sleep 2
echo $cy
figlet "Thanks You Beban Negara Jangan Lupa Balik Lagi ya beban keluarga "
sleep 2
echo $cy"FIKS GUA DOA ELU GAN[ MR ARIF ] YANG BUAT SC INI SEMOGA KELAK NANTI BAKALAN SUKSES AMINNN...... "
sleep 2
echo $y"oke mungkin kata kata gua agak kasar cuk gu minta maaf oky by jangan lupa balik lagi cuk"
exit

else
	echo $r"Pilih input Yang bener dong sayang goblok amat sih:v"
	sleep 2
	sh 'BEBANKELUARGA.sh'
fi
clear
